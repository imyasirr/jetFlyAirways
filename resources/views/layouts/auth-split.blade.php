...
<head>
    ...
    @endif
    <title>@yield('title', 'Sign In') — {{ $siteSetting?->brand_name ?? 'Jet Fly Airways' }}</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 820px) {
            ...
            .form-foot-bar { flex-direction: column; align-items: stretch; }
            .form-foot-bar__rest { text-align: center; }
            .auth-back { justify-content: center; }
        }
    </style>
    @stack('styles')
</head>
<body>
    ...
    <div class="shell">
        <div class="brand-pane">
            ...
            <div class="brand-mid">
                <h1>@yield('brand_title')</h1>
                <p>@yield('brand_desc')</p>
            </div>
